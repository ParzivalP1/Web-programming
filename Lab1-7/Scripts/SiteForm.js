...
function pushIt() {
    if (JSON.parse(localStorage.getItem('tab1es')).queue.length === 5){
        alert("Можно создать только 5 эементов, если хотите создать новые элементы, то сначала удалите старые");
        //
        // localStorage.getItem('tab1es').valueOf().endsWith(tab1es.queue.
        return;
